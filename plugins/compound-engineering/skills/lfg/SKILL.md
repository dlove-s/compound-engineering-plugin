---
name: lfg
description: Right-sized engineering autopilot from idea to PR -- assesses task complexity and runs the appropriate amount of ceremony, from direct edits for trivial fixes to the full brainstorm-plan-implement-review-test pipeline for complex features.
